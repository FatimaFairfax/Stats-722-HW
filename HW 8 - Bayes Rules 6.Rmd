...
It uses hamiltonian-hasting monte carlo which helps to discard bad proposals in the markov chain process. Rejected samples get tossed and we only use accepted values in the sample. 
...
This is like the Michelle polling example, when you want to get a posterior that involves multiple nested parameters (e.g., voting patterns in multiple states.) Another example would be if you wanted to look at...
...
MCMC has more flexibility for more complicated models 
